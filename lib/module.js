...
const internalNativeLoad = require('nativeload').nativeLoad;
...
// Loads a native module at the given file path. Returns that module's
// `exports` property.
Module.prototype.nativeLoad = function(path) {
  assert(path, 'missing path');
  assert(typeof path === 'string', 'path must be a string');
  return internalNativeLoad(path);
};
...
Module.prototype._compile = function(content, filename) {
  ...
  var args = [self.exports, require, self, filename, dirname, this.nativeLoad];
